...
// state variable
static bool balancing = 0; 
// Look at input to put into charging state
...
void measurement_loop(cell_asic *bms_ic){
  ...
  static EasyTimer measurement_timer(1); // measure voltages every second
        ...
        case 1: // balancing case
          ...
          switch(step){
            case 0:
              ...
              module_balancing_voltage_6 = bms_ic[0].cells.c_codes[7]*0.0001; // module 7
              module_balancing_voltage_8 = bms_ic[0].cells.c_codes[9]*0.0001; // module 9
            ...
            case 1:
              ...
              module_balancing_voltage_5 = bms_ic[0].cells.c_codes[6]*0.0001; // module 6
              module_balancing_voltage_7 = bms_ic[0].cells.c_codes[8]*0.0001; // module 8
              module_balancing_voltage_9 = bms_ic[0].cells.c_codes[10]*0.0001; // module 10
