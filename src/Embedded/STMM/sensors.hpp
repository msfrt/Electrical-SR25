...
void sample_ADCs_1() {
    ...
    if(sample_timer_1.isup()) {
        adc1.sample(seg_1_mod_0, seg_1_mod_1, seg_1_mod_2, seg_1_mod_3, seg_1_mod_4, seg_1_mod_5);
        adc2.sample(seg_1_mod_6, seg_1_mod_7, seg_1_mod_8, seg_1_mod_9, seg_1_mod_10, seg_1_mod_11);
    }
}
...
void sample_ADCs_2() {
    ...
    if(sample_timer_2.isup()) {
        adc1.sample(seg_2_mod_0, seg_2_mod_1, seg_2_mod_2, seg_2_mod_3, seg_2_mod_4, seg_2_mod_5);
        adc2.sample(seg_2_mod_6, seg_2_mod_7, seg_2_mod_8, seg_2_mod_9, seg_2_mod_10, seg_2_mod_11);
    }
}
...
void sample_ADCs_3() {
    ...
    if(sample_timer_3.isup()) {
        adc1.sample(seg_3_mod_0, seg_3_mod_1, seg_3_mod_2, seg_3_mod_3, seg_3_mod_4, seg_3_mod_5);
        adc2.sample(seg_3_mod_6, seg_3_mod_7, seg_3_mod_8, seg_3_mod_9, seg_3_mod_10, seg_3_mod_11);
    }
}
...
void sample_ADCs_4() {
    ...
    if(sample_timer_4.isup()) {
        adc1.sample(seg_4_mod_0, seg_4_mod_1, seg_4_mod_2, seg_4_mod_3, seg_4_mod_4, seg_4_mod_5);
        adc2.sample(seg_4_mod_6, seg_4_mod_7, seg_4_mod_8, seg_4_mod_9, seg_4_mod_10, seg_4_mod_11);
    }
}
...
void sample_ADCs_5() {
    ...
    if(sample_timer_5.isup()) {
        adc1.sample(seg_5_mod_0, seg_5_mod_1, seg_5_mod_2, seg_5_mod_3, seg_5_mod_4, seg_5_mod_5);
        adc2.sample(seg_5_mod_6, seg_5_mod_7, seg_5_mod_8, seg_5_mod_9, seg_5_mod_10, seg_5_mod_11);
    }
}
...
void sample_ADCs_6() {
    ...
    if(sample_timer_6.isup()) {
        adc1.sample(seg_6_mod_0, seg_6_mod_1, seg_6_mod_2, seg_6_mod_3, seg_6_mod_4, seg_6_mod_5);
        adc2.sample(seg_6_mod_6, seg_6_mod_7, seg_6_mod_8, seg_6_mod_9, seg_6_mod_10, seg_6_mod_11);
    }
}
...
void sample_ADCs_7() {
    ...
    if(sample_timer_7.isup()) {
        adc1.sample(seg_7_mod_0, seg_7_mod_1, seg_7_mod_2, seg_7_mod_3, seg_7_mod_4, seg_7_mod_5);
        adc2.sample(seg_7_mod_6, seg_7_mod_7, seg_7_mod_8, seg_7_mod_9, seg_7_mod_10, seg_7_mod_11);
    }
}
...
void sample_ADCs_8() {
    ...
    if(sample_timer_8.isup()) {
        adc1.sample(seg_8_mod_0, seg_8_mod_1, seg_8_mod_2, seg_8_mod_3, seg_8_mod_4, seg_8_mod_5);
        adc2.sample(seg_8_mod_6, seg_8_mod_7, seg_8_mod_8, seg_8_mod_9, seg_8_mod_10, seg_8_mod_11);
    }
}
