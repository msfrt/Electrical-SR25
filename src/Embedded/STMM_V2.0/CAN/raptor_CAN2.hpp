...
void read_STMM_363(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt810.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt809.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_362(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt807.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt806.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_361(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt804.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt803.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_360(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt801.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt800.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_359(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt710.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt709.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_358(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt707.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt706.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_357(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt704.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt703.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_356(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt701.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt700.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_355(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt610.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt609.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_354(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt607.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt606.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_353(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt604.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt603.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_352(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt601.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt600.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_351(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt510.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt509.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_350(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt507.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt506.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_349(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt504.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt503.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_348(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt501.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt500.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_347(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt410.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt409.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_346(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt407.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt406.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_345(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt404.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt403.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_344(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt401.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt400.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_343(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt310.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt309.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_342(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt307.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt306.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_341(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt304.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt303.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_340(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt301.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt300.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_339(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt210.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt209.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_338(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt207.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt206.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_337(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt204.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt203.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_336(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt201.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt200.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
...
void read_STMM_332(const CAN_message_t &imsg) {
	...
	STMM_segmentVolt101.set_can_value((imsg.buf[2]) | (imsg.buf[3] << 8));
	STMM_segmentVolt100.set_can_value((imsg.buf[4]) | (imsg.buf[5] << 8));
